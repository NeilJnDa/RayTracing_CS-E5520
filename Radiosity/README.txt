...
Visualizing bounces separately (2p): There are four buttons at the right-bottom corner which can be used to show all results are a single bounce.
Quasi Monte Carlo sampling(2p): I implemented QMC with Halton sequence both for light sampling and hemisphere sampling in the indirect bounces.
...
Currently no problems but I would say the indirect lighting is not visually perfect.

# Did you collaborate with anyone in the class?
(Did you help others? Did others help you? Let us know who you talked to, and what sort of help you gave or received.)
I frequently checked the slack channel and found a lot of really useful information.
...
This assignment is really insightful for understading how to achieve global illumination!
